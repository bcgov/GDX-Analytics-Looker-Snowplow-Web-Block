view: workbc_career_discovery_click {
  derived_table: {
    sql: SELECT wp.id AS page_view_id,
          ...
          CASE WHEN click_type = 'career_profile' THEN 1 ELSE 0 end AS career_profile_count,
        ...
        FROM atomic.ca_bc_gov_workbc_career_quiz_search_click_1 AS sc
  ...
  measure: career_profile_count {
    type: sum
    sql: ${TABLE}.career_profile_count;;
  }
