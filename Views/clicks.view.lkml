...
# Custom dimension for TIBC reporting
  dimension: tibc_click_conversion{
    type: string
    sql: CASE WHEN ${TABLE}.target_urlhost NOT IN ('www.british-columbia.cn', 'www.britishcolumbia.ca', 'www.britishcolumbia.jp', 'www.britishcolumbia.kr', 'app.britishcolumbia.ca') THEN 'External Link'
              ...
              WHEN ${target_urlscheme} = 'mailto' THEN 'Email Link'
        ELSE NULL END ;;
