view: com_snowplowanalytics_snowplow_duplicate_1 {
  sql_table_name: atomic.com_snowplowanalytics_snowplow_duplicate_1 ;;

  dimension: original_event_id {
    type: string
    sql: ${TABLE}.original_event_id ;;
  }
